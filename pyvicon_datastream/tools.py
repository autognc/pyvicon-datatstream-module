...
class ObjectTracker:
    ...
    def _get_object_pose(self, name, ret_quat=True):
            ...
            for seg_idx in range(segment_count):
                ...
                if ret_quat:
                    ...
                    if segment_global_translation is not None and segment_global_rotation is not None:
                        ...
                        quaternion_w = segment_global_rotation[0]
                        quaternion_x = segment_global_rotation[1]
                        quaternion_y = segment_global_rotation[2]
                        quaternion_z = segment_global_rotation[3]
    ...
    def get_pose(self, object_name, ret_quat=True):
        if self.is_connected == True:
            ...
            if frame == pv.Result.Success:
                ...
                position    = self._get_object_pose(object_name, ret_quat)
